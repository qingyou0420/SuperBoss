...
from superboss.modules.directory.router import router as directory_router
...
from superboss.modules.placeholder.router import router as placeholder_router
