...
> **后续**：本文所列 N37–N43、E4 / U1-d / G 清单与决策点 R / AA–AE 在 `3071705`（含 `925529b` / `6ff8389` / `3071705` 三个提交）上的复核结果见第七版 [`审查与迭代方案-Fable51-UI-第七版-3071705.md`](./审查与迭代方案-Fable51-UI-第七版-3071705.md)。
